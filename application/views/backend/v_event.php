...
<div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel">Tambah Event</h3>
    </div>
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/event/simpan_event'?>" enctype="multipart/form-data">
        <div class="modal-body">

            <div class="form-group">
                <label class="control-label col-xs-2" >Event</label>
                <div class="col-xs-8">
                    <input name="nama_event" class="form-control" type="text" placeholder="Objek Wisata..." required>
                </div>
            </div>
...
<div class="modal fade" id="ModalUpdate<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/event/update_event'?>" enctype="multipart/form-data">
        <div class="modal-body">

            <div class="form-group">
                <label class="control-label col-xs-2" >Event</label>
                <div class="col-xs-8">
                    <input name="nama_event" value="<?php echo $nama_event;?>" class="form-control" type="text" placeholder="Objek Wisata..." required>
                </div>
            </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'backend/event/hapus_event'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
                     <input type="hidden" name="kode" value="<?php echo $id;?>"/> 
                          <p>Apakah Anda yakin mau menghapus Event <b><?php echo $nama_event;?></b> ?</p>
