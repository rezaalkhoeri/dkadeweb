          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  <td> <?php echo $no++;?> </td>
                  <td><?php echo $a->namaPaket;?></td>
                  <td><?php echo $a->harga;?></td>
                  <td><?php echo $a->deskripsi;?></td>
                  <td>
                        <a class="btn" data-toggle="modal" data-target="#ModalUpdate<?php echo $a->idpaket;?>"><span class="fa fa-pencil"></span></a>
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $a->idpaket;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
              <?php endforeach;?>
                </tbody>
