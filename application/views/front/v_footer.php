...
<div id="footer">
            <div class="container section end">
                <div id="footer-about" class="one-fourth column">
                    <p><img src="<?php echo base_url().'assets/images/logo-dkade.png'?>" width="100px" alt="" />
                    </p>
                    <p>
                ...
                <div id="footer-offers" class="one-fourth column">
                    <h4><span class="footer left">Tari</span></h4>
                    <ul>
                    <?php
                    foreach ($tari as $h) {?>
                        <li>
                            <a href="<?php echo base_url().'tarian/detail_tari/'.$h->idtari;?>"><img width="50" height="50" src="<?php echo base_url().'assets/gambars/'.$h->gambar;?>" alt="" /> <?php echo $h->nama_tari;?></a>
                        </li>
                    <?php } ?> 
                    </ul>
                </div>
