                    ...
                    <div id="blog" class="container section">
                        ...
                        ?>
                            <div class="blog-item">
                                ...
                                <h2 class="blog"><a href="<?php echo base_url().'wisata_post/detail_wisata/'.$idberita;?>"><?php echo $judul;?></a></h2>
                                ...
                                <p>
                                    <a href="<?php echo base_url().'wisata_post/detail_wisata/'.$idberita;?>" class="small blue button">Read more ...</a>
                                </p>
                            </div>
                            <?php
                            }
